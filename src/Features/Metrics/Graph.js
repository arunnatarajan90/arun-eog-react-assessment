...
export default ({ graphData = [] }) => {
  ...
  let yaxisDataKey =
    totalData[0] && totalData[0].flareTempValue
      ? 'flareTempValue'
      : totalData[0] && totalData[0].casingPressureValue
      ? 'casingPressureValue'
      : totalData[0] && totalData[0].injValveOpenValue
      ? 'injValveOpenValue'
      : totalData[0] && totalData[0].oilTempValue
      ? 'oilTempValue'
      : totalData[0] && totalData[0].tubingPressureValue
      ? 'tubingPressureValue'
      : totalData[0] && totalData[0].waterTempValue
      ? 'waterTempValue'
      : '';
  ...
  return (
    <div>
      ...
      >
        ...
        <YAxis dataKey={yaxisDataKey} tickCount={10}></YAxis>
